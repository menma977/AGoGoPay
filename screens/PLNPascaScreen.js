...
export default class PLNPascaScreen extends React.Component {
    constructor ( props ) {
        super( props );
    ...
    async componentDidMount () {
        ...
        this.setState( {
            ...
            product: [
                { name: 'PLN Pasca Bayar', code: 'PLNPAC;2' },
                { name: 'PLN Non Taglist', code: 'PLNNON;2' },
            ],
        } );
                        ...
                        <Container>
                            <Header style={ { backgroundColor: '#ffffffff' } } >
                                ...
                                <Body style={ { alignItems: 'center' } }>
                                    <Title style={ { color: '#4b3854ff' } }>PASCABAYAR</Title>
                                </Body>
                            </Header>
